...
@Component({
  selector: 'app-fil-detalle-compra',
  templateUrl: './fil-detalle-compra.component.html',
  styleUrls: ['./fil-detalle-compra.component.scss']
})
export class FilDetalleCompraComponent implements OnInit {

  @Output()
  filter: EventEmitter<DetalleCompra[]> = new EventEmitter<DetalleCompra[]>();
