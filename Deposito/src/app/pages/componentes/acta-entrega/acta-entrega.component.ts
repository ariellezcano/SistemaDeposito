...
if(fecha != undefined){
  ...
  var fecha_formateada = dia + ' días del mes de ' + meses[mes] + ' del año ' + yyyy + ' siendo horas '+hora+':'+minutos[minuto];
}else{
  var fecha_formateada = +"____"+ ' días del mes de ' + "___________" + ' del año ' + "________" + ' siendo horas '+"___"+':'+"___";
}
